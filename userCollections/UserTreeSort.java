...
public class UserTreeSort {
	public static void main(String[] args) {
		...
		set.add(new CustomeUser(101,"Shivesh"));
		set.add(new CustomeUser(102,"Pushpa"));
		set.add(new CustomeUser(103,"Rajath"));
		set.add(new CustomeUser(104,"Harish"));
		set.add("Hi");
		set.add("Hello");
		set.add("What's up");
...
class CustomeUser {
  ...
  public CustomeUser(int id, String name) {
      this.id = id;
      this.name = name;
  }
  public int getId() {
...
class SortOneNumFirst implements Comparator<Object> {
  ...
  public String toString() {
	...
	public int compare(Object o1, Object o2) {
		...
		else if(o1 instanceof CustomeUser)
		{
			if(o2 instanceof CustomeUser)
			{
				int id1 = ((CustomeUser)o1).getId();
				int id2 = ((CustomeUser) o2).getId();
				return id1-id2;
			}
			else 
				return 1;
	...
	public int compare(Object o1, Object o2) {
  	if(o1 instanceof String)
		...
		else if(o1 instanceof CustomeUser)
		{
			if(o2 instanceof CustomeUser)
			{
				int id1 = (int)((CustomeUser) o1).getId();
				int id2 = (int)((CustomeUser) o2).getId();
				return id1-id2;
			}
			else 
				return -1;
  ...
  public String toString() {
	...
	public int compare(Object o1, Object o2) {
		...
		else if(o1 instanceof String)
		{
			...
			else if(o2 instanceof CustomeUser)
			{
				String s2 = ((CustomeUser)o2).getName();
				return s1.compareTo(s2);
			}
			else
				return -1;
		...
		{
			String s1 = ((CustomeUser)o1).getName();
			if(o2 instanceof String)
			{
				String s2 = (String)o2;
				return s1.compareTo(s2);
